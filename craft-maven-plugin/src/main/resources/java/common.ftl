...
<@format blank=4*depth>
{
    ...
    <#elseif field.type.getCode() == "BIGDECIMAL">
    ${parent} = new java.math.BigDecimal(protocol.read${field.type.getName()?lower_case?cap_first}());
...
if (${parent} != null) {
    ...
    <#elseif field.type.getCode() == "BIGDECIMAL">
        protocol.write${field.type.getName()?lower_case?cap_first}(${parent}.toString());
    <#elseif field.type.getCode() == "ENUM">
