...
@javax.annotation.Generated(value = "Autogenerated by Craft IDL Compiler (1.0.0)", date = "2019-3-2 13:10:33")
public interface UserService {
    ...
    public static class Client extends io.craft.core.client.CraftClient implements UserService {
        ...
        {
            int messageId = send_get(id);
            return recv_get(messageId);
        }

        private int send_get(java.lang.Long id) throws org.apache.thrift.TException
        {
        ...
        private io.craft.abc.model.UserModel recv_get(int messageId) throws org.apache.thrift.TException
        {
            get_result result = new get_result();
            receiveBase(messageId, result, "get");
        ...
        {
            int messageId = send_gets(ids);
            return recv_gets(messageId);
        }

        private int send_gets(java.util.List<java.lang.Long> ids) throws org.apache.thrift.TException
        {
        ...
        private io.craft.abc.model.UserModel recv_gets(int messageId) throws org.apache.thrift.TException
        {
            gets_result result = new gets_result();
            receiveBase(messageId, result, "gets");
            if (result.success != null) {
                return result.success;
            }
            return null;
        ...
        {
            int messageId = send_ping();
            recv_ping(messageId);
        }

        private int send_ping() throws org.apache.thrift.TException
        {
        ...
        private void recv_ping(int messageId) throws org.apache.thrift.TException
        {
            ping_result result = new ping_result();
            receiveBase(messageId, result, "ping");
        }
