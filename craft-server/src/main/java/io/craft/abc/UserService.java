...
@javax.annotation.Generated(value = "Autogenerated by Craft IDL Compiler (1.0.0)", date = "2019-3-1 15:19:25")
public interface UserService {
    ...
    public static class Client extends io.craft.core.client.CraftClient implements UserService {
        ...
        {
            io.netty.channel.Channel channel = send_get(id);
            return recv_get(channel);
        }

        private io.netty.channel.Channel send_get(java.lang.Long id) throws org.apache.thrift.TException
        {
        ...
        private io.craft.abc.model.UserModel recv_get(io.netty.channel.Channel channel) throws org.apache.thrift.TException
        {
            get_result result = new get_result();
            receiveBase(channel, result, "get");
        ...
        {
            io.netty.channel.Channel channel = send_gets(ids);
            return recv_gets(channel);
        }

        private io.netty.channel.Channel send_gets(java.util.List<java.lang.Long> ids) throws org.apache.thrift.TException
        {
        ...
        private io.craft.abc.model.UserModel recv_gets(io.netty.channel.Channel channel) throws org.apache.thrift.TException
        {
            gets_result result = new gets_result();
            receiveBase(channel, result, "gets");
            if (result.success != null) {
                return result.success;
            }
            return null;
        ...
        {
            io.netty.channel.Channel channel = send_ping();
            recv_ping(channel);
        }

        private io.netty.channel.Channel send_ping() throws org.apache.thrift.TException
        {
        ...
        private void recv_ping(io.netty.channel.Channel channel) throws org.apache.thrift.TException
        {
            ping_result result = new ping_result();
            receiveBase(channel, result, "ping");
        }
